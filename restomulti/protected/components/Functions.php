...
/*
		return array(
		  ...
		  4=>yii::t("default","Dine in")
		);
*/
		return array(
		  1=>Yii::t("default","Delivery"),
		  2=>Yii::t("default","Takeout"),
		  3=>yii::t("default","Dine in"),
		  4=>yii::t("default","Deliver & Takeout"),
		  5=>yii::t("default","Deliver, Takeout & Dine in")
		);
	}
	...
	{
		return array(
			1=>Yii::t("default","Volledig halal"),
			2=>Yii::t("default","Deels halal"),
			3=>Yii::t("default","Kosher"),
			4=>Yii::t("default","Vis beschikbaar"),
			5=>Yii::t("default","Vegetarisch beschikbaar")
		);
	}
	...
	public function merchantMenu()
	{
		...
		$payment_list=array('visible'=>$this->hasMerchantAccess("payment-gateway"),'tag'=>'payment-gateway','label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   array('visible'=>$this->hasMerchantAccess("mol"),'tag'=>'btr', 'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Mollie"), 
                   'url'=>array('merchant/mollieSettings')),                                                            
		...
		return array(  
		    ...
		    'items'=>array(
                ...
                array('visible' => $this->hasMerchantAccess("HalalClassificatie"), 'tag' => "HalalClassificatie", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Halal Classificatie"),
                        'url' => array('/merchant/HalalClassificatie')),
	...
	public function hasMerchantAccess($tag='')
	{
		...
		$tag_paymentgateway=array(
		  'mollie','paypal','stripe','mercadopago','ide','payu','pys','ccr','bcy','epy','pyr',
		...
		return array(  
		    ...
		    'items'=>array(
                ...
                'label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   array('visible'=>$this->AA('mollieSettings'),'tag'=>'mollieSettings',
                   'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Mollie"), 
                   'url'=>array('admin/mollieSettings')),                             
