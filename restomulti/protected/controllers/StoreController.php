...
class StoreController extends CController
{
	...
	public function actionSearchArea()
	{
		...
		//print_r($_GET['zipcode']);
		//print_r($_GET['service']);
		//echo "asdf";
		//exit(0);
		...
		// norio code
		$filter_delivery_type=isset($_GET['filter_delivery_type'])?explode(",",$_GET['filter_delivery_type']):false;		
    ...
    public function actionMollieInit() {
        $this->render('mollie-init');
    }

    public function actionMollieReturn() {
        $this->layout = 'old_form';
        $this->render('mollie-return-page');
    }

    public function actionMollieVerify() {
        $this->render('mollie-webhook-verification');
    }

    public function actionTipus() {
    	$this->render('tipus');
    }
