...
header('Location: '.Yii::app()->request->baseUrl."/merchant/smsReceipt/id/".Yii::app()->db->getLastInsertID());
    ...
    public function actionHalalClassificatie() {
        $this->crumbsTitle = Yii::t("default", "Halal Classificatie");
        $this->render('halal_classificatie');
    }

	public function actionMollieSettings()
	{
		$this->crumbsTitle=Yii::t("default","Mollie Settings");
		$this->render('mollie-settings');
	}
    public function actionMollieInit() {
        $this->crumbsTitle = Yii::t("default", "Mollie Payment");
